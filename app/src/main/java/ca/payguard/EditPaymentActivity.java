...
public class EditPaymentActivity extends AppCompatActivity{
    ...
    /**
     * Forwards a string $ amount added to previous $ amount to the TapCard activity.
     * Will pass an int to TapCard called 'preAuthAmount'.
     * @param amount: Must start with $ and must be convertible to an Int.
     */
    protected void forwardAmount(String amount){
        int dollars = Integer.parseInt(amount.substring(2));
